      ...
      <ul className=" text-gray-400 m-5 w-full flex flex-col ">
        ...
        <div className="mt-5 flex items-center justify-arround">
          <div className=" flex items-center">
            ...
            <li className="w-11/12 flex items-center text-white after:inline-block after:content-['5'] after:mr-5 after:ml-10 after:rounded-full after:bg-orange-500 after:text-white after:w-6 after:h-6 after:text-center">
              Requests
            </li>
          </div>
          <svg
